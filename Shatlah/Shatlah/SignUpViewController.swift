...
class SignUpViewController: UIViewController {
    ...
    private func setUpUI(){
        [profilePic,email,isServiceProvider,firstName,lastName,password,passwordConfirm,signUp,cancelBtn].forEach{view.addSubview($0)}
        ...
        NSLayoutConstraint.activate([
            ...
            isServiceProvider.leadingAnchor.constraint(equalTo: email.trailingAnchor,constant: 5),
            isServiceProvider.heightAnchor.constraint(equalToConstant: 30),
            isServiceProvider.widthAnchor.constraint(equalToConstant: 30),
            isServiceProvider.centerYAnchor.constraint(equalTo: email.centerYAnchor),
